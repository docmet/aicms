...
- [x] **WP-04**: MCP tools available for WP: `wp_list_pages`, `wp_get_page`, `wp_update_page`, `wp_create_page`, `wp_publish_page`
- [x] **WP-05**: MCP tools available for WP: `wp_list_posts`, `wp_update_post`, `wp_create_post`, `wp_publish_post`
...
| WP-04 | Phase 15 | Complete |
| WP-05 | Phase 15 | Complete |
